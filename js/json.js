...
const mainCon = document.getElementById("json-array");
const cardP = document.getElementById("cards");

for(let i=0; i<products.length; i++){
    const len = products[i]

    const productItem = document.createElement("div")
    productItem.className = "product-card";

    const pCategory = document.createElement("div")
    pCategory.className = "prod-category";

    const pImage = document.createElement("div")
    pImage.className = "prod-img";
    ...
    pRating.className = "prod-rating";


    const button = document.createElement("div")
    button.className = "p-button";
    const pButton = document.createElement("button")
    pButton.onclick = "clickMe"
    pButton.id = "click-me";
    pButton.className = "p-but";
  ...
  pButton.addEventListener("click", ()=>{
    ...
    productItem.appendChild(pCategory);

    productItem.appendChild(pImage);
    pImage.appendChild(pImg);

    productItem.appendChild(titleName);
    productItem.appendChild(productPrice);
    productItem.appendChild(prodDesc);
    productItem.appendChild(pRating);
